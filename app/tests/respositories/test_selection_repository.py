...
async def test_get_all_selections(selection_repository, mocker):
    ...
    mocker.patch.object(selection_repository.db_pool, 'acquire', return_value=mocked_connection)
...
async def test_create_selection(selection_repository_create, mocker):
    ...
    mocker.patch.object(selection_repository_create.db_pool, 'acquire', return_value=mocked_connection)
...
async def test_update_selection(selection_repository_update, mocker):
    ...
    mocker.patch.object(selection_repository_update.db_pool, 'acquire', return_value=mocked_connection)
    ...
    updated_selection = await selection_repository_update.update(selection_id, updated_selection_data)
